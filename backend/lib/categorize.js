...
const BUILTIN_RULES = [
  ...
  { category: 'entertainment', patterns: ['netflix','spotify','youtube','apple','google one','google play','patreon','openai','chatgpt','מפעל הפיס','קולנוע','cinema','תיאטרון','סטנד אפ','stand up','concert','הופעה','כרטיסים','mmclub','workhuman','google youtubepremium','טעינות','מל מסיבה','רדיו גליל','סוויפט הוד','ז\'לינסקי','weezevent','הטבות פיס'] },
  { category: 'finance',       patterns: ['ביטוח','פנסיה','קרן','השקעות','ישראכרט חיוב','אלטשולר','מגדל','הראל ביטוח חיים','כלל ביטוח','בלינק','פיקדון','הלוואה','משכנתא','טפחות','פירעון','הקמת הלוואה','תשלום מס','ריבית','קבלת תשלום','קנייה בה.קבע','איביאי','סיסקו סיסט'] },
